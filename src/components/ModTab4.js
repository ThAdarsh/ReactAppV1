...
const ModTab4 = () => {
  ...
  return (
    ...
    <div className='container-2'>
      ...
      <h1>Module Four <NavLink to="/SearchComp">< SearchIcon className='seachIconProp' fontSize='xxl-large'/></NavLink><NavLink to="/HomeComp2"><HomeIcon color='disabled' fontSize='large' /></NavLink></h1>
