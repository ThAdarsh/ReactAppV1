...
import Img3 from '../images/Img-7.jpg';
...
const ModTab2 = () => {
  ...
  return (
    ...
    <div className='container-2'>
      ...
      <h1>Module Two <NavLink to="/SearchComp">< SearchIcon className='seachIconProp' fontSize='xxl-large'/></NavLink><NavLink to="/HomeComp2"><HomeIcon color='disabled' fontSize='large' /></NavLink></h1>
